...
import org.kkrasowski.cinema.spi.Configuration
...
class FilmSchedulerImpl(private val films: FilmsCatalogue,
                        ...
                        private val configuration: Configuration) : FilmScheduler {
    ...
    private fun RoomOccupation.isWithinValidHours() = when {
        hasAttribute(Attribute.PREMIERE) -> startsAfterOrExactlyAt(configuration.premieresStartHour) && endsBeforeOrExactlyAt(configuration.premieresEndHour)
